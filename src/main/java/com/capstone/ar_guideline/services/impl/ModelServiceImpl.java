...
public class ModelServiceImpl implements IModelService {
    ...
    public ModelResponse create(ModelCreationRequest request) throws InterruptedException {
      ...
      DatasetRequest datasetRequest =
          ...
          DataStatusResponse dataStatusResponse = new DataStatusResponse("0e553950-2a32-44cd-bd53-ed680a00f2e5");
            String file = "";
    ...
    @Override
    public PagingModel<ModelResponse> findByCompanyId(int page, int size, String companyId, String type, String name) {
        try {
