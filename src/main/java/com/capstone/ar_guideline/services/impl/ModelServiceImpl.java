...
public class ModelServiceImpl implements IModelService {
    ...
    public ModelResponse update(String id, ModelCreationRequest request) {
        try {
            Model modelByIdWithRedis = (Model) redisTemplate.opsForHash().get(ConstHashKey.HASH_KEY_MODEL, id);
            ModelType modelTypeByIdWithRedis = (ModelType) redisTemplate.opsForHash().get(ConstHashKey.HASH_KEY_MODEL_TYPE, request.getModelTypeId());
    ...
    public Model findById(String id) {
        ...
        Model modelById = modelRepository.findById(id)
