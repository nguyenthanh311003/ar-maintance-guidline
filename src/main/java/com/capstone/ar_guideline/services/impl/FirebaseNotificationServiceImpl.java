...
public class FirebaseNotificationServiceImpl implements IFirebaseNotificationService {
    ...
    public Boolean registerDeviceToken(DeviceRegistrationRequest request) {
        try {
            ...
            log.info("Device token registered: {} for user: {} in company: {}",
                    request.getToken(), request.getUserId(), request.getCompanyId());
            return true;
        } catch (Exception e) {
    ...
    public Boolean subscribeToTopic(String token, String topic) {
        try {
            ...
            log.info("Successfully subscribed to topic: {}, successes: {}, failures: {}",
    ...
    public Boolean unsubscribeFromTopic(String token, String topic) {
        try {
            ...
            log.info("Successfully unsubscribed from topic: {}, successes: {}, failures: {}",
                    topic, response.getSuccessCount(), response.getFailureCount());
