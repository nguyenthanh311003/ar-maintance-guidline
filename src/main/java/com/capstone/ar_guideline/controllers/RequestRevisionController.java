...
public class RequestRevisionController {
    ...
    @PostMapping
    public ResponseEntity<RequestRevisionResponse> createRequestRevision(@RequestBody RequestRevisionRequest request) {
    ...
    public ResponseEntity<List<RequestRevisionResponse>> getAllByCompanyRequestId(@PathVariable String companyRequestId) {
        List<RequestRevisionResponse> responses = requestRevisionService.getAllByCompanyRequestId(companyRequestId);
