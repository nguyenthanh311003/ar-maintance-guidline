...
//        log.info("Fetching lessons with page: {}, size: {}, searchTemp: {}", page, size, searchTemp);
...
//    }
    ...
    public ApiResponse<LessonResponse> createLesson(@RequestBody @Valid LessonCreationRequest request) {
    ...
    public ApiResponse<String> deleteLesson(@PathVariable String lessonId) {
        ...
        return ApiResponse.<String>builder()
                .result("Lesson has been deleted successfully")
                .build();
    }
}
