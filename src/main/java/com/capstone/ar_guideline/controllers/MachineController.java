...
public class MachineController {
    ...
    public ApiResponse<MachineResponse> createMachine(
            @RequestBody MachineCreationRequest request) {
        return ApiResponse.<MachineResponse>builder().result(arGuidelineService.createMachine(request)).build();
    }
    ...
    public ApiResponse<MachineResponse> updateMachine(
        ...
        return ApiResponse.<MachineResponse>builder().result(arGuidelineService.updateMachineById(machineId, request)).build();
    }
}
