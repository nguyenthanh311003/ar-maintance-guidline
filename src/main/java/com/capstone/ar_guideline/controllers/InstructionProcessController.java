...
public class InstructionProcessController {
  ...
  @Autowired IInstructionProcessService instructionProcessService;
  ...
  public ApiResponse<InstructionProcessResponse> createLesson(
    ...
    return ApiResponse.<InstructionProcessResponse>builder()
        .result(instructionProcessService.createInstructionProcess(request))
        .build();
  }

  @GetMapping(value = ConstAPI.InstructionProcessAPI.InstructionProcess)
  public ApiResponse<List<InstructionProcessResponse>> createLesson(
      @RequestParam(required = true) String userId,
      @RequestParam(required = true) String courseId) {
    return ApiResponse.<List<InstructionProcessResponse>>builder()
        .result(instructionProcessService.getInstructionProcessesByUserId(userId, courseId))
        .build();
  }
}
