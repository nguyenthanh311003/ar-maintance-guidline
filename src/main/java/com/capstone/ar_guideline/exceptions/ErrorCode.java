...
public enum ErrorCode {
  ...
  NOTIFICATION_REGISTRATION_FAILED(1127, "Failed to register notification device", HttpStatus.BAD_REQUEST),
  TOPIC_SUBSCRIPTION_FAILED(1127, "Failed to subscribe to notification topic", HttpStatus.BAD_REQUEST),
  TOPIC_UNSUBSCRIPTION_FAILED(1127, "Failed to unsubscribe from notification topic", HttpStatus.BAD_REQUEST),
